...
class Level:
    ...
    def create_map(self):
        ...
        self.limiters_sprites = self.create_tile_group(limiters_layout, 'limiters')
        ...
        self.island_ends_sprites = self.create_tile_group(island_ends_layout, 'island ends')
        ...
        self.grass_elements_sprites = self.create_tile_group(grass_elements_layout, 'grass elements')
        ...
        self.sand_hole_sprites = self.create_tile_group(sand_hole_layout, 'sand hole')
        ...
        # portal components
        portal_components_layout = import_csv_layout(self.map['portal components'])
        self.portal_components_sprites = self.create_tile_group(portal_components_layout, 'portal components')
        ...
        self.ruined_portal_sprites = self.create_tile_group(ruined_portal_layout, 'ruined portal')
        ...
        self.clouds = Clouds(SCREEN_HEIGHT*2,level_width,30, self.all_sprites)
        ...
        for row_index, row in enumerate(layout):
            for col_index, val in enumerate(row):
                ...
                if val != '-1':
                    ...
                    if type == 'grass':
                        grass_tile_list = import_cut_graphics('levels_data/graphics/decoration/grass/hub_grass.png')
                    ...
                    if type == 'rocks':
                        if val == '0': sprite = Rocks((x, y), self.all_sprites, pygame.image.load('levels_data/graphics/decoration/rocks/rock1.png').convert_alpha())
                        if val == '1': sprite = Rocks((x, y), self.all_sprites, pygame.image.load('levels_data/graphics/decoration/rocks/rock2.png').convert_alpha())
                    ...
                    if type == 'limiters':
                        ...
                        Tile((x, y), [self.all_sprites, self.collision_sprites], tile_surface)
